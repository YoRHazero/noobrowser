import { Box, Stack, NumberInput, Field } from "@chakra-ui/react";
...
export default function CuroutNormControler() {
    ...
    const handleCutoutPminChange = (next: number) => {
        ...
        if (cutoutSortedArray) {
            const newVmin = percentileFromSortedArray(cutoutSortedArray, clampedValue, true) as number;
    ...
    const handleCutoutPmaxChange = (next: number) => {
        ...
        if (cutoutSortedArray) {
            const newVmax = percentileFromSortedArray(cutoutSortedArray, clampedValue, true) as number;
