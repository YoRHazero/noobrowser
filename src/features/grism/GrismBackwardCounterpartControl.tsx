...
import { HorizontalNormRangeSlider, HorizontalOpacitySlider } from "@/components/ui/internal-slider";
...
export default function GrismBackwardCounterpartControl() {
    ...
    const isImageGray = (filterRGB.r === filterRGB.g && filterRGB.g === filterRGB.b);
            ...
            <Box>
                ...
                <HStack gap={2} justify="space-between">
                    <FilterSelectorCard
                        ...
                        color="red.400"
                        isActive={displayMode.includes('r') && !!filterRGB.r && !isImageGray}
                    ...
                    <FilterSelectorCard
                        ...
                        options={availableFilters}
                        color="green.400"
                        isActive={displayMode.includes('g') && !!filterRGB.g && !isImageGray}
                    ...
                    <FilterSelectorCard
                        ...
                        options={availableFilters}
                        color="blue.400"
                        isActive={displayMode.includes('b') && !!filterRGB.b && !isImageGray}
        ...
        <Button
            ...
            onClick={() => {
                ...
                if (!filterRGB.r || !filterRGB.g || !filterRGB.b) {
                    toaster.error({ title: "Incomplete RGB filter", description: "Please set all RGB filter values." });
                    return;
                }
...
function CounterpartVisibilitySwitch() {
    ...
    const setCounterpartVisible = useGrismStore((state) => state.setCounterpartVisible);
    return (
        <HStack gap={2}>
