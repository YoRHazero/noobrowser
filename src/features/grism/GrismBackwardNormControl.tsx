...
import { VStack, HStack, Text, Switch, Box } from "@chakra-ui/react";
...
export default function GrismBackwardNormControls() {
    ...
    /*                                    Logic                                   */
    /* -------------------------------------------------------------------------- */
    const lookupGlobalNorm = useCallback((p: number) => {
    ...
    const handleGlobalPSliderChange = (newP: number, which: "pmin" | "pmax") => {
        ...
        if (newV !== null) { // Check for null explicitly
    ...
    return (
        <VStack gap={4} align="stretch">
            ...
            <Box h="16px">
                {isRoiLoading && (
                    <Text fontSize="xs" color="cyan.300" textAlign="center" animation="pulse 1s infinite">
