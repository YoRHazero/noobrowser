import { Box, Grid, GridItem, Kbd, Text, VStack } from "@chakra-ui/react";
...
function RoiZoomView({
	...
	/*                             Norm to be applied                             */
	/* -------------------------------------------------------------------------- */
	const zoomVmin = backwardNormIndependent
		? backwardRoiNorm.vmin
		: backwardGlobalNorm.vmin;
	const zoomVmax = backwardNormIndependent
		? backwardRoiNorm.vmax
		: backwardGlobalNorm.vmax;
	...
	return (
		<Box p={4} borderTop="1px solid #333" bg="gray.900">
			...
			<Grid templateColumns="auto 1fr" gap={2} fontSize="xs" color="gray.400">
				<GridItem>
					<Kbd>Shift</Kbd> + <Kbd>q</Kbd> / <Kbd>Shift</Kbd> + <Kbd>e</Kbd>
				</GridItem>
