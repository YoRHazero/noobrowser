...
import { LuActivity, LuRefreshCw, LuRuler, LuTrash2 } from "react-icons/lu";
			...
			<Box css={styles.panel}>
							...
							>
								<NumberInput.Input
									...
									_focus={{
										...
										boxShadow: "0 0 0 1px var(--chakra-colors-border-accent)",
									}}
								/>
							</NumberInput.Root>
						</Stack>
				...
				<Box css={styles.statusDisplay}>
					<HStack
						justify="center"
						gap={4}
						separator={<Text color="border.subtle">|</Text>}
					>
						<Text>SRC: {totalSources.toString().padStart(2, "0")}</Text>
						<Text>
							MAIN: {mainId ? mainId.slice(0, 8).toUpperCase() : "N/A"}
						</Text>
					</HStack>
				</Box>
