...
const THEME_STYLES = {
    ...
    cardRoot: (selected: boolean) => ({
        ...
        // 选中时的默认光晕（可选，保持常亮或无）
        boxShadow: selected 
            ? { base: "0 0 0 1px var(--chakra-colors-cyan-500)", _dark: "0 0 10px rgba(6, 182, 212, 0.15)" }
            : "none",
        ...
        _hover: {
            ...
            // 3. 关键：炫酷光晕 (Glow) 代替位移
            // Light Mode: 清晰的青色外环
            // Dark Mode: 赛博朋克风的弥散光晕
            boxShadow: selected
                ? { 
                    base: "0 0 0 2px var(--chakra-colors-cyan-400), 0 4px 12px rgba(6, 182, 212, 0.3)", 
                    _dark: "0 0 15px rgba(6, 182, 212, 0.5), 0 0 2px var(--chakra-colors-cyan-400)" 
                  }
                : { 
