import { Badge, Box, Flex, Heading, HStack, IconButton, Stack, Text, CloseButton, Drawer } from "@chakra-ui/react";
import { Info, CheckCircle, Clock, Ban, Trash2 } from "lucide-react";
...
export default function GrismFitJobDrawerHeader({
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            ...
            case "failed": return <Ban size={12} />;
